...
export const Home: React.FC = () => {
  ...
  const handleLogin = async () => {
    try {
      ...
      console.log("Inicio de sesión exitoso desde Home");
    } catch (error) {
  ...
  return (
    <div className="w-full bg-gray-50 dark:bg-gray-900">
      ...
      {/* 🔹 Call to Action: solo visible si NO ha iniciado sesión */}
      {!user && (
        <section className="bg-secondary-100 dark:bg-gray-800 py-12 mt-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <button
              onClick={handleLogin}
              className="btn btn-secondary hover:bg-secondary-600 transition-colors"
            >
              Registrarme ahora
            </button>
          </div>
